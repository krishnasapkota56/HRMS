...
urlpatterns = [
    ...
    path('approveReimbursement', approveReimbursementView,
         name='approveReimbursement'),
    path('approveReimbursement/<int:pk>/',
         approveReimbursementUpdate.as_view(), name='approveReimbursementUpdate'),
    path('approveLeave', approveLeaveView, name='approveLeave'),
    path('approveLeave/<int:pk>/', approveLeaveUpdate.as_view(),
         name='approveLeaveUpdate'),
    path('approveMeeting', approveMeetingView, name='approveMeeting'),
    path('approveMeeting/<int:pk>/', approveMeetingUpdate.as_view(),
         name='approveMeetingUpdate'),
